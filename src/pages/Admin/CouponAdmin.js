...
import { PlusCircleOutlined, EditOutlined, DeleteOutlined, MenuUnfoldOutlined, MenuFoldOutlined } from '@ant-design/icons';
...
const CouponAdmin = () => {
  const user = useSelector((state) => state?.user);
    ...
    console.log("stateCoupons", stateCoupon);
    console.log("stateCouponsDetails", stateCouponDetail);
                ...
                >
                  ...
                  >
                    <Form.Item
                      label="Tên coupon"
                      name="name"
                      rules={[{ required: true, message: "Hãy nhập tên coupon!" }]}
                    >
                      <InputComponent
                    ...
                    >
                      <InputNumber
                        ...
                        onChange={(value) =>
                          hanleOnChangeDetail({ target: { name: "discount", value } })
                        }
                        name="discount"
                        style={{ width: "100%" }}
                      />
                    ...
                    >
                      <DatePicker
                        value={stateCouponDetail.startDate ? moment(stateCouponDetail.startDate) : null}
                        onChange={(date) =>
                          hanleOnChangeDetail({
                    ...
                    >
                      <DatePicker
                        value={stateCouponDetail.endDate ? moment(stateCouponDetail.endDate) : null}
                        onChange={(date) =>
                          hanleOnChangeDetail({
